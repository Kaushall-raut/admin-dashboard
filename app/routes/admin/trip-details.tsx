...
export const loader = async ({ params }: LoaderFunctionArgs) => {
  ...
  return {
    trip,
    allTrips: trips.allTrip.map(({ $id, tripDetail, imageUrl }) => ({
      id: $id,
...
const TripDetails = ({ loaderData }: Route.ComponentProps) => {
  ...
  const pillItems = [
    ...
    {
      text: budget,
      bg: "!bg-success-50 !text-success-500",
    },
    {
      text: interests,
